...
import {
  ...
  showGambar,
  hapus_gambar,
} from "../controller/kasController.js";
...
router.post("/report_pemasukkan", uploads.none(), report_pemasukkan);
router.post("/report_pengeluaran", uploads.none(), report_pengeluaran);
...
router.post("/update_kas/:id", uploads.array("gambar"), update_kas);
