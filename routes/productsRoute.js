...
import { getKas, report_pemasukkan, report_pengeluaran, input_kas, update_kas, hapus_kas, report_saldo } from '../controller/kasController.js'
...
router.post('/input_kas', verifyToken, uploads.single('gambar'), input_kas);
